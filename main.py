...
async def user(genero: str):
    ...
    try:
        ...
        df_usuario_por_genero = pd.read_csv("./Data/UserForGenre.csv")
...
async def user(año: int):
    ...
    try:
        ...
        recomendaciones_anio = pd.read_csv("./Data/UsersRecommend.csv")
...
async def user(año: int):
    ...
    try:
        # Leer el archivo CSV que contiene la información de las recomendaciones para el año dado
        recomendaciones_anio_2 = pd.read_csv("./Data/UsersNotRecommend.csv")
...
async def sentiment_analysis(anio):
    ...
    """
    # Leer el archivo CSV que contiene la información de las recomendaciones para el año dado
    sentimiento_analysis = pd.read_csv("./Data/sentimiento_analysis.csv")
